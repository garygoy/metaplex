...
const Home = (props: HomeProps) => {
        ...
        try {
          ...
          if (e instanceof Error) {
            if (
              ...
              setAlertState({
                open: true,
                message: `Couldn't fetch Favishing Rat state from Favishing Rat with address: ${props.candyMachineId}, using rpc: ${props.rpcHost}! You probably typed the REACT_APP_CANDY_MACHINE_ID value in wrong in your .env file, or you are using the wrong RPC!`,
                severity: 'error',
                hideDuration: null,
              });
            } else if (
              ...
              setAlertState({
                open: true,
                message: `Couldn't fetch Favishing Rat state with rpc: ${props.rpcHost}! This probably means you have an issue with the REACT_APP_SOLANA_RPC_HOST value in your .env file, or you are not using a custom RPC!`,
                severity: 'error',
                hideDuration: null,
              });
            }
  ...
  const onMint = async (
    ...
    try {
      ...
      // updates the Favishing Rat state to reflect the latest
    ...
    <Container style={{ marginTop: 100 }}>
      <Container maxWidth="xs" style={{ position: 'relative' }}>
        ...
        >
          ...
          >
            Favishing Rat Collection

            <div>
              <img style={{ width: 250, height: 250, borderRadius: "50%", marginTop: 10 }} src="logo512.png" alt="" />
            </div>
          </Typography>
